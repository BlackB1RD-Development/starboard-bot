...
const provider = require('./Util/SqliteProvider');
...
class StarBoardClient extends Client {
   ...
   * @param {number} [settings.maxAge] - this is for cache service of sqlite provider.
   */
  constructor(options, settings) {
    ...
    this.db = new sqlite('database.sql');
    this.provider = new provider(this, this.db, settings);

    this.on('ready', async () => await this.provider._init());
